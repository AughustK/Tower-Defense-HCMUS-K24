...
void Victory::onEnter(World& world) {
    std::cout << "[Victory] onEnter called\n";
    ...
    const string fontPath = "assets/Font/Pixel Game.otf";
    const string musicPath = "assets/SFX/Music/Victory.mp3";
    ...
    const string bgPath = "assets/Bg/VictoryBg.png";
...
void Victory::render(World& world, sf::RenderWindow& window) 
{
...
void Victory::handleEvent(World& world, sf::Event& event)
{
