...
void Credit::onEnter(World& world)
{
    ...
    TextComponent textComp0(str0, 80, fontPath, Color::White, { 1920 / 2, 75 }, false);
    ...
    TextComponent textComp1(str1, 60, fontPath, Color::White, { 1920 / 2, 200 }, false);
    ...
    TextComponent textComp5(str5, 40, fontPath, Color::White, { 1920 / 2, 525 + 50 }, false);
    world.addComponent(text4, textComp5);

    EntityID text5 = world.createEntity();
    registerEntity(text5);
    const string str6 = "ART";
    TextComponent textComp6(str6, 40, fontPath, Color::White, { 1920 / 2, 625 + 50 }, false);
    ...
    TextComponent textComp7(str7, 40, fontPath, Color::White, { 1920 / 2, 675 + 50 }, false);
    world.addComponent(text6, textComp7);

    EntityID text7 = world.createEntity();
    registerEntity(text7);
    const string str8 = "UI DESIGN";
    TextComponent textComp8(str8, 40, fontPath, Color::White, { 1920 / 2, 775 + 50 }, false);
    ...
    TextComponent textComp9(str9, 40, fontPath, Color::White, { 1920 / 2, 825 + 50 }, false);
