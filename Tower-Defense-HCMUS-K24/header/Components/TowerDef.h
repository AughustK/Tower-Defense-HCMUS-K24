...
static constexpr TowerDef TOWER_DEFS[] = 
{
    ...
    { TowerComponent::TowerType::Archer, {1.0f, 1.2f},  {300.0f, 350.0f},  {10.0f, 15.0f}, {200.0f, 220.0f}, 5.0f,    14.0f },
    { TowerComponent::TowerType::Mage,   {0.8f, 1.0f},  {250.0f, 300.0f},  {20.0f, 30.0f}, {180.0f, 200.0f}, 6.0f,     0.0f },
    { TowerComponent::TowerType::Cannon, {0.5f, 0.7f},  {200.0f, 250.0f},  {50.0f, 75.0f}, {220.0f, 240.0f}, 8.0f,     0.0f },
};