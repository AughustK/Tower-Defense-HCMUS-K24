...
{
    if (!backgroundCreditsTexture.loadFromFile("D:/HCMUS/OOP/Project/Picture/CreditBackground2Fixed.png")) return false;
    backgroundCreditsSprite.setTexture(backgroundCreditsTexture);
    backgroundCreditsSprite.setPosition(0, 0);


    if (!creditTexture.loadFromFile("D:/HCMUS/OOP/Project/Picture/testCreditV2.png")) return false;
    ...
    if (!exitButtonTexture.loadFromFile("D:/HCMUS/OOP/Project/Picture/Icon/Back/A_Back2.png")) return false;
